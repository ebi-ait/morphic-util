...
class CmdSubmitFile:
    ...
    def _process_submission(self, submission_instance, list_of_files_in_upload_area):
        ...
        if self._is_add_action():
            ...
            # TODO: read parent cell line name
            parent_cell_line_id = self._submit_parent_cell_line(submission_instance, "test1.1")
            created_expression_alterations = self._submit_expression_alterations(submission_instance, parsed_data)
    ...
    def _submit_expression_alterations(self, submission_instance, parsed_data):
        ...
        return create_expression_alterations(
            ...
            parsed_data['expression_alterations']
        )
